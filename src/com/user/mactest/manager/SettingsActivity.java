...
import com.user.calc.R.string;
import com.user.calc.R.xml;
...
public class SettingsActivity extends PreferenceActivity implements  OnPreferenceClickListener{
	...
	private void setupSimplePreferencesScreen() {
		...
		Preference pref1 = getPreferenceScreen().getPreference(1);
		Preference pref2 = getPreferenceScreen().getPreference(2);
